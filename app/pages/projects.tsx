...
export default function Projects({ setActiveTab }: ProjectsProps) {
    ...
    <div className="space-y-6 w-full lg:max-w-5xl 2xl:max-w-6xl">
        <p className="text-zinc-500 text-lg max-w-[800px] leading-relaxed mb-12">
            Several projects I've built in the past. Visit Github Repos to explore the tech stack, 
                        ...
                        <div className="flex flex-col md:flex-row md:items-center gap-6">
                            ...
                            <div className="flex items-center gap-6 md:gap-4">
                                {proj.siteUrl && (
                                    ...
                                    className="cursor-none text-white hover:text-zinc-500 transition-colors text-[11px] md:text-sm font-bold uppercase tracking-widest ml-1">Live Site &rarr;</a>
                                )}
                                <a href={proj.repoUrl} target="_blank" rel="noopener noreferrer" 
                                className="cursor-none text-white hover:text-zinc-500 transition-colors text-[11px] md:text-sm font-bold uppercase tracking-widest">Github Repo &rarr;</a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div className="border-b border-white/10 pb-6 last:border-0">
            ...
            <AnimatePresence>
                ...
                <div className="pt-8 pb-4 grid gap-6 pointer-events-auto">
                    <p className="text-base md:text-lg text-zinc-300 leading-relaxed mb-2">
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        className="cursor-none text-white hover:text-zinc-500 transition-colors text-[11px] md:text-sm font-bold uppercase tracking-widest ml-1">v1.0 Site &rarr;</a>
                        <a href="https://annaw99.vercel.app/" target="_blank" rel="noopener noreferrer" 
                        className="cursor-none text-white hover:text-zinc-500 transition-colors text-[11px] md:text-sm font-bold uppercase tracking-widest">v2.0 Site &rarr;</a>
                    </div>
                </div>
                </motion.div>
                )}
